...
<div id="primary">
	...
	echo '<div id="my-content" class="__wps__wrapper">';	
		if ($wps_user->is_permitted()) { 
			...
			echo '<div id="my-menu">';
				if ($wps_user->get_id() == $current_user->ID) {
					echo '<div id="menu_wall" class="__wps__profile_menu">My Activity</div>';
				} else {
					echo '<div id="menu_wall" class="__wps__profile_menu">Activity</div>';
				}
				echo '<div id="menu_activity" class="__wps__profile_menu">Friends Activity</div>';
				echo '<div id="menu_all" class="__wps__profile_menu">All Activity</div>';
			...
			echo '<div style="clear:both;">';
				echo $wps_ui->profile_placeholder("wall", "__wps__placeholder");
			echo '</div>';
