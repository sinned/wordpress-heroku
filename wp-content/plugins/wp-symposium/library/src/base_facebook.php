 ...
 */
class __wps__FacebookApiException extends Exception
{
  /**
 ...
 * @author Naitik Shah <naitik@facebook.com>
 */
abstract class __wps__BaseFacebook
{
  /**
   * Version.
   */
  ...
  protected function makeRequest($url, $params, $ch=null) {
    ...
    if ($result === false) {
      $e = new __wps__FacebookApiException(array(
  ...
  protected function throwAPIException($result) {
    $e = new __wps__FacebookApiException($result);
    switch ($e->getType()) {
      // OAuth 2.0 Draft 00 style
      case 'OAuthException':
        // OAuth 2.0 Draft 10 style
